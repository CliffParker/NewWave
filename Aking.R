...
stew(file="Aaron_pomp_results.rda",{
  ...
  for (name in names) {
    ...
    firstFit <- mif2(m1, Nmif = 50, start = parest, Np = 10000, 
                     rw.sd = rw.sd(
                       R0=0.3, mu=0.3, sigma=0.3, gamma=0.3, 
                       alpha=0.3, iota=0.3, rho=0.3, sigmaSE=0.3, 
                       psi=0.3, cohort=0.3, amplitude=0.3,
                       S_0=ivp(0.3),E_0=ivp(0.3),I_0=ivp(0.3),R_0=ivp(0.3)) , transform = T,
